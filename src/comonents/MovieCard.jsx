    ...
    return(
        <div className="relative overflow-hidden"    >
            <Link to={`/details/${movies.id}`}>
                <img src={IMAGE_PATH + (movies.poster_path?movies.poster_path:movies.backdrop_path)} alt={movies.original_title} className="border-2  border-gray-600 rounded-3xl hover:opacity-75 transition ease-in-out duration-150"/>
            </Link>

    ...
    return(
        <div className="mt-8 relative overflow-hidden"    >
            ...
            <div className="absolute top-0 right-0 px-2 py-2">
                <div className="text-xs sm:text-xs sm:ml-4 md:text-sm lg:text-lg opacity-70 bg-orange-400 font-bold rounded-xl p-1 text-gray-700">Release Date:  {movies.release_date}</div>
	        </div>
            <div className="mt-2">
